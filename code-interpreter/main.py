...
def main():
    ...
    If it does not seem like you can write code to answer the question, just return "I don't know" as an answer.
    """
    ...
    #                     that point to www.github.com/vyshnev, you have qrcode package installed already"""
    #     }
    # )
    ...
    print(
        grand_agent_executor.invoke(
            {
                "input": "Generate and save in current working directory 15 qrcodes that point to www.github.com/vyshnev, you have qrcode package installed already "
            }
        )
    )
